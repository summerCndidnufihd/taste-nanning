...
<div class="page-container">
    <form action="${pageContext.request.contextPath}/api/img/addFoodImage" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-article-add">
        <div class="row cl">
