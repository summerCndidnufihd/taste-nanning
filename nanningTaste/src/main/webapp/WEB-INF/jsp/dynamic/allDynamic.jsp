...
<div >
    ...
    <div class="page-container">
        <div class="text-c">
            <form id="searchForm" action="${pageContext.request.contextPath}/api/dynamic/getDynamicById" method="post">
                <input type="text" name="d_id" id="d_id" placeholder=" 输入动态ID..." style="width:250px" class="input-text">
                <button type="submit" value="搜索"  class="btn btn-success"  >搜索</button>
            </form>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20">
		 <span class="l"><a href="${pageContext.request.contextPath}/api/dynamic/checkNoDynamic" onclick="datadel()" class="btn btn-danger radius">
		 <i class="Hui-iconfont"></i> 查看审核不通过的列表</a>
		  <a class="btn btn-primary radius" href="${pageContext.request.contextPath}/api/dynamic/checkYesDynamic" >
		  <i class="Hui-iconfont"></i> 查看审核通过的列表</a></span>
        </div>
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <c:forEach items="${list}" var="list">
                    <tr class="text-c">
                        ...
                        <td class="td-manage">
                            <a style="text-decoration:none" class="ml-5" onClick="dynamic_del(this,${list.d_id})" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
...
<script type="text/javascript">
                ...
                $.ajax(
                    {
                        ...
                        success:function(result){
                            layer.closeAll();
                            $(obj).parents("tr").find(".td-manage").prepend('<a onClick="dynamic_check_yes(this,id)" href="javascript:;" title="通过" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>');
            ...
            $.ajax(
                {
                    ...
                    success:function(result){
                        layer.closeAll();
                        $(obj).parents("tr").find(".td-manage").prepend('<a onClick="dynamic_check_no(this,id)" href="javascript:;" title="停用" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>');
    ...
    /*美食-删除*/
    function dynamic_del(obj,f_id){//id为取到的行id
