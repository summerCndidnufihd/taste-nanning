...
<div >
    ...
    <div class="page-container">
        <div class="text-c">
            <form id="searchForm" action="${pageContext.request.contextPath}/api/advert/getAdvertById" method="post">
            <input type="text" name="a_id" placeholder=" 广告ID..." style="width:250px" class="input-text">
            <button name="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜广告</button>
            </form>
        </div>
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <c:forEach items="${list}" var="list">
                    <tr class="text-c">
                        ...
                        <td>${list.a_id}</td>
                        <td>${list.a_title}</td>
                        <td><img src="http://localhost:8080/upload/${list.a_img}" alt="" style="width: 100px;height: 80px"></td>
                        <td class="text-c">${list.s_id}</td>
                        <td class="td-manage"><a style="text-decoration:none" class="ml-5" onClick="advert_edit(${list.a_id})" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
...
<script type="text/javascript">
    ...
    function advert_edit(id){
        location.href="${pageContext.request.contextPath}/api/advert/toEditAdvert/"+id;
    }
