    ...
    <c:forEach items="${list}" var="list">
        <div class="row cl">
            <div class="formControls col-xs-8 col-sm-9">
                <input type="hidden" class="input-text" value="${list.s_id}" placeholder="" name="f_id">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商家名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${list.storeName}" placeholder="" name="foodName">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${list.storeTag}" placeholder="" name="f_img">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商家地址：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${list.s_location}" placeholder="" name="f_details">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">人均价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${list.s_price}" placeholder="" name="foodTag">
            </div>
        </div>
        <div class="row cl">
